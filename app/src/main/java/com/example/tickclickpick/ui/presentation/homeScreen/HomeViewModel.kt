...
class HomeViewModel(private val foodRepository: IFoodRepository): ViewModel(), IHomeViewModel {
    private var foodModelList by mutableStateOf(emptyList<FoodModel>())
