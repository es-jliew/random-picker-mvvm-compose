...
A self taught personal project to create a simple random picker Android application with CRUD functions that can persists recipes to local database with best practices such as MVVM, Jetpack Compose and Dependancy Injection.
